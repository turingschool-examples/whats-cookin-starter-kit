...
describe('User', () => {
  ...
  it('Should return the array with added recipe', () => {
    expect(user1.addToFavorites(recipe1)).to.deep.equal([{
      "id": 595736,
    ...
    expect(user1.favorites[0]).to.deep.equal([{
      "id": 595736,
      "image": "https://spoonacular.com/recipeImages/595736-556x370.jpg",
      "ingredients": [
        {
    ...
    expect(user1.addToFavorites(recipe2)).to.deep.equal({
      "id": 678353,
  ...
  it('Should return favorites array without removed recipe', () => {
    expect(user1.removeFromFavorites(recipe1).to.deep.equal([]))
  });
  ...
  it('Should return all the recipes in favorites array that match the filter tag', () => {
    expect(user1.filterFavsByTag('dinner')).to.deep.equal([user1.favorites[0]]);
  });
