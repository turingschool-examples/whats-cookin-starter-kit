...
describe( 'RecipeRepository', ( ) => {
  ...
  beforeEach( ( ) => {
      ...
      recipeRepo = new RecipeRepository( dataRecipe, dataIngredient )
  ...
  it( 'should take in recipes', ( ) => {
    expect( recipeRepo.recipes ).to.deep.equal( dataRecipe )
  } );

  it( 'should filter by tag', ( ) => {
    expect( recipeRepo.filterRecipeByTag( 'antipasti' ) ).to.deep.equal( [ dataRecipe[ 0 ] ] )
    expect( recipeRepo.filterRecipeByTag( 'lunch' ) ).to.deep.equal( [ dataRecipe[ 1 ] ] )
    console.log(dataRecipe[1].name)
  } );
