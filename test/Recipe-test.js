...
describe('Recipe', function() {
  ...
  it('should list names of ingredients needed', function() {
    const recipe = new Recipe(allRecipes[0]);
    expect(recipe.returnIngredients()).to.deep.equal('wheat flour, bicarbonate of soda, eggs, sucrose, instant vanilla pudding, brown sugar, salt, fine sea salt, semi sweet chips, unsalted butter, vanilla')
  });
