...
describe("RecipesContainer", () => {
  ...
  beforeEach(function() {
    ...
    },
    {
      ...
      "ingredients": [
        {"id": 1002030, "quantity": {"amount": 4, "unit": "teaspoons"}},
        {"id": 1042047, "quantity": {"amount": 4, "unit": "teaspoons"}}
      ],
      "instructions": [
        {"instruction": "Mix the hot sauce, butter, mango habanero sauce, brown sugar, chili powder, garlic powder, onion powder, black pepper, cayenne pepper and seasoning salt in a bowl. Stir vigorously until completely combined.", "number": 1}
      ],
